...
import com.example.borja.data.local.ChatDatabase
import com.example.borja.data.network.NetworkModule
import com.example.borja.data.repository.ChatRepositoryImpl
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                ChatViewModel(
                    ChatRepositoryImpl(NetworkModule.chatApi, database.messageDao())
                )
            }
        }
    }
